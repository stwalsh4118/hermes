...
### Acceptance Criteria
- [ ] Migration directory created with proper structure
- [ ] Up migration file creates all 4 tables
- [ ] Down migration file drops all tables
- [ ] All columns defined with correct types
- [ ] UUID primary keys on channels, media, playlist_items
- [ ] Foreign key constraints defined with CASCADE delete
- [ ] Unique constraints on playlist_items(channel_id, position)
- [ ] Indexes created for performance
- [ ] Settings table limited to single row
- [ ] Migration helper function created in Go
...
### New Files Created
- `migrations/000001_initial_schema.up.sql` - Up migration
- `migrations/000001_initial_schema.down.sql` - Down migration
- `internal/db/migrations.go` - Migration helper functions
