...
### Acceptance Criteria
- [ ] Manager interface includes all existing methods plus new observability methods
- [ ] playlistManager struct defined with all required fields
- [ ] Design supports windowSize=0 (VOD/EVENT) and windowSize>0 (live) modes
- [ ] Media sequence tracking strategy documented
- [ ] Thread-safety considerations documented

## Files Modified

### Files to Modify
- `api/internal/streaming/playlist/manager.go` — Update Manager interface and define playlistManager struct
