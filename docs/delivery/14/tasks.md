...
| :------ | :--- | :----- | :---------- |
| 14-1 | [Design playlistManager data structure and interface implementation](./14-1.md) | Proposed | Design the improved Manager interface and playlistManager struct |
