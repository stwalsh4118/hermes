...
| 14 | Developer | As a developer, I want a custom HLS playlist writer/reader that we fully control so that we can eliminate library bugs and have reliable playlist generation | Proposed | Custom playlist manager replaces hls-m3u8 library; no panics or index errors; sliding window works correctly; atomic writes; >80% test coverage; hls-m3u8 dependency removed |
...
- [PBI 14: Custom HLS Playlist Writer/Reader](./14/prd.md)
...
| 20251028-120000 | 8 | propose_for_backlog | PBI-8 approved with technical decisions: @dnd-kit for drag-drop, URL-based icon input, retro UI design, React Hook Form validation | User |
| 20251028-180000 | 8 | approve | PBI-8 completed: Channel management UI with list, create, edit, playlist management, media browser, drag-drop reordering, and bulk operations | User |
...
| 20251111-234000 | 14 | create_pbi | PBI-14 created: Custom HLS playlist writer/reader to replace buggy hls-m3u8 library with reliable custom implementation | AI_Agent |
