...
- [ ] MediaTreeNode types defined in web/lib/types/media-tree.ts
- [ ] use-media-tree hook implements tree organization logic
- [ ] Tree component renders hierarchical structure correctly
- [ ] Selection at any level (show/season/episode) works correctly
- [ ] Expand/collapse functionality works
- [ ] Search/filter integration maintains tree structure
- [ ] Virtual scrolling implemented for performance
- [ ] Keyboard navigation functional
- [ ] ARIA labels and roles present
- [ ] Component follows design system (borders, fonts, spacing)
- [ ] Responsive on mobile devices
- [ ] Performance acceptable with 1000+ items
- [ ] Unit tests pass for tree organization logic
- [ ] Component ready for integration in 9-2 and 9-4
...
### Dependencies
- react-virtual or similar (for virtual scrolling)
- lucide-react (for chevron/checkbox icons)
- Existing: @/lib/types/api (Media type)
- Existing: @/components/ui/* (checkbox, scrollarea components)
