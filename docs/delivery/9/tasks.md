...
| 9-2C | [Remove Pagination Limits for Media Library Display](./9-2C.md) | Proposed | Fix 20-item limit so MediaTree displays entire library using virtual scrolling |
